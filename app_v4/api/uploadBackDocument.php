...
if(!empty($_FILES['file_attachment']['name']))
  {
    ...
    if (
      ...
      $documentBackImage= $_FILES["file_attachment"]["name"];
      $query = "UPDATE customer SET accountVetified = '0',varificationType = 'm', documentBackImage = '$newfilename', documentName = '$docType' where id = '$userId'";
