...
$number = $data->number;
$curl = curl_init();
// $url = "https://myrc.in/plan_api/bill?username=503142&token=9de2e6e3de7d7ea54e6c67c0d6976b22&number=".$number."&number=".$opcode;
$url = "https://planapi.in/api/Mobile/BillCheck?apimember_id=4996&api_password=vishnu123&Accountno=".$number."&operator_code=".$opcode;
// echo $url;
