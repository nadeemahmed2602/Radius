...
// 1 BNB = 250 USD
	  ...
	  if ($res_add_amount_in_wallet > 0) {
		$q_transaction = "INSERT INTO `transaction` (`id`, `user_id`, `amount`, `dateTime`, `status`, `transaction_type`, `affected_wallet`, `payment_for`, `mobile_number`, `consumer_number`, `operator_code`, `flight_no`, `wallet_balance`, `utility_balance`, `investment_balance`, `earning_balance`) VALUES (NULL, '$user_id', '$convertedAmount', CURRENT_TIMESTAMP, 'debit', 'wallet_withdraw', 'wallet', 'wallet_withdraw', NULL, NULL, NULL, NULL, '$walletDepositAmount', '0', '0', '0');";
